...
export default function Signup({
  ...
  const handlePendingAuth = (provider) => {
    showToast(`${provider} signup will be enabled once API keys are provided.`);
          ...
          <form onSubmit={handleSignup} style={{ animation: "slideUp 0.4s ease" }}>
            ...
            <div style={{ display: "grid", gap: "16px", marginBottom: "24px", paddingTop: "24px", borderTop: "1px solid #f0f0f0" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "12px" }}>
                ...
                <input type="text" name="zipCode" placeholder="ZIP Code" value={formData.zipCode} onChange={handleInputChange} className="user-input" />
              </div>
            </div>
