      ...
      <div style={{
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: "0", margin: "0" }}>
            ...
            <li style={{ marginBottom: "8px", cursor: "pointer" }}><a onClick={() => handleGiftConciergeClick()} style={{ color: "#ccc", textDecoration: "none", fontSize: isMobile ? "13px" : "14px", cursor: "pointer" }}>Gift Concierge</a></li>
